package library.localsearch.constraints.basic;

import library.localsearch.constraints.alldifferent.AllDifferent;
...
public class NotEqual extends AbstractInvariant implements IConstraint{
	...
	public static void main(String[] args) {
		...
		library.localsearch.search.TabuSearch s = new library.localsearch.search.TabuSearch();

package library.localsearch.constraints.multiknapsack;


import library.localsearch.model.*;
...
public class MultiKnapsack extends AbstractInvariant implements IConstraint {
	...
	public static void main(String[] args) {
		...
		mns.print();
		 ...
		 library.localsearch.applications.Test T = new library.localsearch.applications.Test();
		 T.test(S, 10000);
		 
		 if(true) return;
		 library.localsearch.search.TabuSearch ts = new library.localsearch.search.TabuSearch();
			ts.search(S, 10, 5, 100000, 100);
		 //library.localsearch.search.SA_search ts=new library.localsearch.search.SA_search();

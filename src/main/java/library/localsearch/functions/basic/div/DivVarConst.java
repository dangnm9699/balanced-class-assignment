package library.localsearch.functions.basic.div;
...
public class DivVarConst extends AbstractInvariant implements IFunction {
	...
	public DivVarConst(VarIntLS x, int a){
		// semantic x / a
		_x = x; _a = a;
	...
	private void post(){
		...
		_vars[0] = _x;
		_minValue = _x.getMinValue() / _a;
		_maxValue = _x.getMaxValue() / _a;
		_ls.post(this);
	}
	@Override

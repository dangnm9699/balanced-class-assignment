package library.localsearch.functions.max_min;


import library.localsearch.functions.basic.FuncPlus;
import library.localsearch.functions.basic.FuncVarConst;
...
public class FMin extends AbstractInvariant implements IFunction {
	private int _value;
